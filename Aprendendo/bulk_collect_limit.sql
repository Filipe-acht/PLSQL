...
AS
  vLimit CONSTANT INTEGER(2) := 30; /* tamanho do buffer da clasula LIMIT */
...
BEGIN
  ...
  LOOP
    ...
    BULK COLLECT INTO employee_id_table LIMIT vlimit; /* ele vai carregar apenas as primeiras 30 linhas(LIMIT) */
    
    EXIT WHEN employee_id_table.COUNT = 0; /* se o array estiver vazio, sair do loop */
