...
BEGIN
  ...
  OPEN pemployees_cursor /* abrindo o cursor declarado no parametro */
  /* result set do cursor */
...
IS
  employees_cursor  SYS_REFCURSOR; /* se torna um cursor */
  vfirst_name  employees.first_name%TYPE;
  vlast_name   employees.last_name%TYPE;
BEGIN
  PRC_CURSOR_EMPLOYEES(employees_cursor); /* chamando a procedure e realizando o open do cursor */
  ...
  LOOP
    ...
    DBMS_OUTPUT.PUT_LINE(vfirst_name || ' ' || vlast_name); /* imprimindo */
